    ...
    <div>
        <div class="wrap">
            <div class="container pb-3 pt-5">
                <div class="col-lg-12 col-sm-12 mb-sm-5 mb-lg-0 pb-4">
                    <StepBar :status="status"></StepBar>
                </div>
                <h5 v-if="!order.is_paid" class="text-center font-weight-bold">商品確認</h5>
                ...
                <div class="my-5 row justify-content-center text-white">
                    <img v-if="order.is_paid" class="col-md-8 col-sm-12" src="@/assets/image/checkout-img.gif" alt="checkout-img">
